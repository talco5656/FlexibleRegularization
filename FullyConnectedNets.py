...
task = Task.init(project_name='Flexible Regularization', task_name='Fully Connected Nets')
    ...
    for reg_strenght in reg_strenghts:
        # for lr in learning_rates:
            ...
            for update_rule in ['sgd', 'sgd_momentum', 'adam', 'rmsprop']:
                ...
                model = FullyConnectedNetOriginal([WIDTH]*5, weight_scale=5e-2, reg=reg_strenght)
            ...
            # for update_rule in ['sgd', 'sgd_momentum', 'adam', 'rmsprop']:
                ...
                adaptive_solver = AdaptiveSolver(adaptive_model, small_data, print_every=500,
                              num_epochs=EPOCHES, batch_size=100,
                              update_rule=update_rule,
                              optim_config={
                                'learning_rate': learning_rates[update_rule],
