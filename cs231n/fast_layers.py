...
from cs231n.layers import dropconnect_w
...
def conv_forward_strides_dropconnect(
        x, w, b, conv_param, dropconnect_param, adaptive_dropconnect_weigth):
    def one_forward_pass(x_cols, w, reshaped_b, F, dropconnect_param, adaptive_dropconnect_weight):
        #todo: change to conv forward pass.
        w, w_cache = dropconnect_w(w, dropconnect_param, adaptive_dropconnect_weight)
        out = w.reshape(F, -1).dot(x_cols) + reshaped_b(-1, 1)
    ...
    if dropconnect_param['mode'] == 'train':
        x_cols, w, res = one_forward_pass(x_cols, w, reshaped_b, F, dropconnect_param, adaptive_dropconnect_weigth)
        ...
        for i in range(dropconnect_param['mc dropconnect forword passes']):
            ...
            computation_array.append(one_forward_pass(x_cols, w, reshaped_b, F, dropconnect_param, adaptive_dropconnect_weight))
...
conv_forward_fast_dropconnect = conv_forward_strides_dropconnect
